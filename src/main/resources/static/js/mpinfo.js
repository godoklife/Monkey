...
function info(){
    let html = '<h2 class="content_title">원숭이두창이란?</h2>'+
               ...
               '<p class="content_text">원숭이두창은 1958년 연구를 위해 사육된 원숭이들에서 수두와 비슷한 질병이 발생하였을 때 처음 발견되어 "원숭이두창" 이라는 이름이 붙여졌습니다. 원숭이두창에 감염된 사례는 두창 퇴치에 노력을 기울이던 1970년 콩고민주공화국에서 처음 보고되었으며, 이후 가봉, 나이지리아, 중앙아프리카공화국, 코트디브아르, 콩고공화국, 카메룬 등 중·서부 아프리카 국가에서 보고되며 풍토병화 되었습니다.</p>'+
               '<p class="content_text">그러나, 2022년 5월 이후 스페인, 영국, 이탈리아 등 유럽을 중심으로 발생하기 시작하여 미국 등 풍토병이 아닌 국가에서 이례적으로 발생함에 따라 국내 유입가능성도 점차 증가하여 우리나라는 2022년 6월 원숭이두창을 2급감염병으로 지정하고 감시를 강화하고 있습니다.</p>'+
...
function main_symptoms(){
    ...
    '                    <li class="content_li">임상증상: 발열, 두통, 근육통, 요통, 림프절 부종, 오한, 피로, 발진(발열 후 약 1~3일이내)<br><span>※ 발진은 반점(Macules), 구진(Papules), 수포(Vesicles), 농포(Pustules), 가피(Scabs)의 단계로 진행됨</span></span></li>'+
    ...
    '                    <tr>'+
    '                        <th></th>'+
    '                        <th>원숭이두창<br>(Monkeypox)</th>'+
    '                        <th>수두<br>(Varicella)</th>'+
    '                        <th>대상포진<br>(Herpes zoster)</th>'+
    '                        <th>단순포진<br>(Herpes simplex)</th>'+
    '                        <th>홍역<br>(Measles)</th>'+
    '                    </tr>'+
    '                    <tr id="table_img">'+
    '                        <td>발진 사진</td>'+
    '                        <td colspan="5">혐오스러운 사진이 포함되어 있습니다.<button onclick="img()">사진 확인</button> </td>'+
    '                    </tr>'+
    '                    <tr>'+
    '                        <td>발진 특징</td>'+
    '                        <td>'+
    ...
    '                    <tr>'+
    '                        <td>림프절 비대</td>'+
    '                        <td><ul><li>주로 목, 겨드랑이, 서혜부</li><li>단단한 압통</li></ul></td>'+
    '                        <td><ul><li>드묾</li></ul></td>'+
    '                        <td><ul><li>드묾</li></ul></td>'+
    '                        <td><ul><li>드묾</li></ul></td>'+
    '                        <td><ul><li>드묾</li></ul></td>'+
    '                    </tr>'+
