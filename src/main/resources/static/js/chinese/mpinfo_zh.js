...
function info(){
    let html = '<h2 class="content_title">什么是猴痘？</h2>'+
               ...
               '<p class="content_text">猴痘是最早是在 1958 年发现的，当时一种类似水痘的疾病在为研究而培育的猴子身上出现，因此得名“猴痘是”。 猴痘感染病例于 1970 年在刚果民主共和国首次报告，当时正在努力根猴痘是，此后在加蓬、尼日利亚、中非共和国、科特迪瓦等中非和西非国家都有报告。 “科特迪瓦、刚果共和国和喀麦隆。”</p><br>'+
